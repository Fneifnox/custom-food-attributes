...
public class BetterNetherCompat {
    ...
    public static void initBetterNetherAttributes() {
        Item blackApple = BuiltInRegistries.ITEM.getValue(Identifier.fromNamespaceAndPath("betternether", "black_apple"));
        Item bowlWithBlackApple = BuiltInRegistries.ITEM.getValue(Identifier.fromNamespaceAndPath("betternether", "stalagnate_bowl_apple"));
        Item cookedHookMushroom = BuiltInRegistries.ITEM.getValue(Identifier.fromNamespaceAndPath("betternether", "hook_mushroom_cooked"));
        Item mushroomStew = BuiltInRegistries.ITEM.getValue(Identifier.fromNamespaceAndPath("betternether", "stalagnate_bowl_mushroom"));
        Item wartSoup = BuiltInRegistries.ITEM.getValue(Identifier.fromNamespaceAndPath("betternether", "stalagnate_bowl_wart"));
